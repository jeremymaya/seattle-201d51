...
function sumArray(sumArr) { //eslint-disable-line
  var sum4 = sum(sum(testArray[0], testArray[1]).shift(), testArray[2]).shift();
  return [sum4, testArray.toString() + ' was passed in as an array of numbers, and ' + sum4 + ' is their sum.'];
}
